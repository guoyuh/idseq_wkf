...
rule all:
    ...
    input:
        ...
        expand("{outdir}/result/{sample}/kraken2/{sample}.report.mpa.rpm.csv",outdir=OUTDIR,sample=SAMPLE),
...
rule  kreport2mpa:
    ...
    shell:
        "python ~/idseq_dag/KrakenTools/kreport2mpa.py --no-intermediate-ranks --read_count  -r {input[0]} -o {output[0]} && python  ~/idseq_dag/kraken_reads_rpm_2.py {input[1]} {output[0]} "
