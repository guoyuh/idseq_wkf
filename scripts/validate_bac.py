...
import pandas as pd
ref_id_file = "/mnt/data/NCBI_Refseq/pathogens_bac_genus_name_all_strain.species_and_strain_id"
ref_id = {}
...
out = open("/mnt/data/NCBI_Refseq/my_bac_assembly_summary_refseq.20210830","w")
out2 = open("/mnt/data/NCBI_Refseq/my_bac_assembly_summary_refseq.20210830_not_reference","w")
