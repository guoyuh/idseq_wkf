...
def get_category_counts(before_filter_mpa_report):
            ...
            if species_re and line.startswith("k__Eukaryota"):
                ...
                for k in fungi_organism_name.keys():
                    if k.find(species_name) != -1:
                        #print("fungi name:======>",species_re,"reads num:+++++++++>",species_re.group(2))
    ...
    print("Eukaryota_amount:",Eukaryota_amount,"fungi_amount:",fungi_amount,"bacteria_amount:",bacteria_amount,"parasites_amount:",parasites_amount,"viruses_amount:",viruses_amount)
...
def negative_control(workdir,remove_host_fq):
            ...
            with open(negative_filter_mpa_report, "r") as fh:
                for line in fh:
                    ...
                    if species_re:
                        ...
                        total_counts = count_reads(remove_host_fq)
...
def read_mpa_report(remove_host_fq,before_filter_mpa_report,filter_mpa_report,workdir,prefix):
    ...
    negative_Species_set = negative_control(workdir=workdir,remove_host_fq = remove_host_fq)
...
if __name__ == '__main__':
    if len(sys.argv) != 6:
        print("usage: python {} remove_host_fq  before_filter_mpa_report filter_mpa_report workdir prefix".format(sys.argv[0]))
        print(
            """
            example:\n
            python  {} remove_host_fq /mnt/home/huanggy/project/20220408/result/21JS944006/kraken2/21JS944006.kreport.mpa.txt /mnt/home/huanggy/project/20220408/result/21JS944006/kraken2/21JS944006.uniq80_kreport.mpa.txt /mnt/home/huanggy/project/20220325 21JS944006_2
            """.format(sys.argv[0])
              )
